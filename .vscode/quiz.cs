...
public class Pro{
    public static void Main(){
       ...
       if(j==ans[11]||j==ans[10]){
        ...
        Console.WriteLine("A class can inherit one or more Structs : 1.True   2.False");
        ...
        if(total<=4){
                Console.WriteLine("-> you are too poor , please try to learn:");
        }
        else if(total<=6&&total>=5){
                Console.WriteLine("->  passed : Work Hard");
        }
